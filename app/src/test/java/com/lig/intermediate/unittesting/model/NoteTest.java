package com.lig.intermediate.unittesting.model;
...
class NoteTest {
    public static final String TIMESTAPS_1 = "05-2019";
    ...
    void isNotesEqual_identicalProperties_returnTrue()  throws Exception {
        Note note1 = new Note("Note #1", "This is note #1", TIMESTAPS_1);
        note1.setId(1);
        Note note2 = new Note("Note #1", "This is note #1", TIMESTAPS_1);
        note2.setId(1);
